        ...
        <div className="overlay">
            <div className="flex flex-col px-1 space-y-3 auto w-80 h-100 flex-grow">
                <div className="space-y-2"> 
                    ...
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "அளவு", result: [[States.LETTER_NOT_FOUND], [States.LETTER_ELSEWHERE], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                    ...
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "சான்று", result: [[States.LETTER_NOT_FOUND, States.UYIR_MATCHED], [States.LETTER_MATCHED], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
