        ...
        <div className="overlay">
            <div className="flex flex-col px-1 space-y-3 auto w-80 h-100 flex-grow">
                <div className="space-y-2"> 
                    ...
                    எடுத்துக்காட்டாக...
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "வானம்", result: [[States.LETTER_NOT_FOUND], [States.LETTER_NOT_FOUND], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                    &apos;ம்&apos; எழுத்து சரியான இடத்தில் உள்ளது. மற்ற இரு எழுத்துக்கள் தவறு
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "சாதம்", result: [[States.LETTER_NOT_FOUND], [States.LETTER_ELSEWHERE], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                    &apos;த&apos; எழுத்து சரி, ஆனால் இடம்மாறி உள்ளது.
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "தசம்", result: [[States.LETTER_MATCHED], [States.LETTER_MATCHED], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                    ...
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "சாதம்", result: [[States.LETTER_NOT_FOUND, States.UYIR_MATCHED], [States.LETTER_MATCHED], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                    ...
                    <div className="flex" >
                        <Tiles word_length="3" words={[{word: "சாதம்", result: [[States.LETTER_NOT_FOUND, States.MEI_MATCHED], [States.LETTER_MATCHED], [States.LETTER_MATCHED]]}]} heading={false} forHelpPage={true}/>
                    </div>
                ...
                <div className="self-center">
                    <button className="rounded bg-green-300 text-blue-800 px-1" onClick={(e) => showHelp(false)}>
                    Close
                    </button>
                </div>
            </div>
